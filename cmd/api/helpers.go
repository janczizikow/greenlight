...
import (
	...
	"github.com/janczizikow/greenlight/internal/validator"
...
func (app *application) readJSON(w http.ResponseWriter, r *http.Request, dst interface{}) error {
	...
	if err != nil {
		...
		// So we check for this using errors.Is() and
		...
		// panic if passed a non-nil pointer to Decode().
	...
	// destination. If the request body only contained a single JSON value this will return an io.EOF error.
